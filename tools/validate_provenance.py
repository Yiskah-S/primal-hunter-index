...
def _check_source_ref_fields(
	ref: dict[str, Any], ref_prefix: str, path: Path, errors: list[Finding], warnings: list[Finding]
...
def _check_event_source_refs(
	entry: dict[str, Any], entry_prefix: str, path: Path
) -> tuple[list[Finding], list[Finding]]:
