...
**Upstream Contracts:** [tagging_contract_v0.4.md](../contracts/tagging_contract_v0.4.md) and [provenance_contract_v2.0.md](../contracts/provenance_contract_v2.0.md)

---

## 🎯 Purpose

This runbook documents how to safely move tags from **candidate stage** → **canonical registry**, validate them, and
ensure they don’t break provenance or schema guardrails.
...
Promotes candidate tags into the canonical registry. Always dry-runs first unless `--commit` is provided.
